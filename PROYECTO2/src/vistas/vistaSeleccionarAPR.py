...
from vistas.vistaValidarCadenaR import PantallaValidarCadenaR
class PantallaSeleccionarAFDR(tk.Toplevel):
    pantallaParent = None
    ...
    def abrir_ventanaECAFD(self):
        ...
        for automataAFD in self.pantallaParent.pantallaParent.automatasCargadosAFD:
            if automataAFD[0] == automataSeleccionado:
                ventanaECAFN= PantallaValidarCadenaR(self, automataAFD)
