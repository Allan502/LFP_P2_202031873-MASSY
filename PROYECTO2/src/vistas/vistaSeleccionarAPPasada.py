...
from vistas.vistaValidarCadenaPasada import PantallaValidarCadenaPasada
class PantallaSeleccionarPasada(tk.Toplevel):
    pantallaParent = None
    ...
    def abrir_ventanaECAFD(self):
        ...
        for automataAFD in self.pantallaParent.pantallaParent.automatasCargadosAFD:
            if automataAFD[0] == automataSeleccionado:
                ventanaPasada= PantallaValidarCadenaPasada(self, automataAFD)
